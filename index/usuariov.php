...
<body>
    <nav>
        <ul class="nav-menu">
            <li><a href="../index/main.php">Inicio</a></li>
            <li><a href="../index/infonosotros.php">Acerca de Nosotros</a></li>
            <li><a href="../index/libros.php">Libros</a></li>
            <li><a href="../Usuarios/misprestamos.php">Mis Prestamos</a></li>
